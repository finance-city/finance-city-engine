...
bool IBLManager::createTextures() {
    ...
    // BRDF LUT: 512x512, RG16Float (RGBA16Float on WebGPU - RG16Float lacks storage support)
    {
        rhi::TextureDesc desc{};
        desc.size = {512, 512, 1};
#ifdef __EMSCRIPTEN__
        desc.format = rhi::TextureFormat::RGBA16Float; // RG16Float doesn't support StorageBinding in WebGPU
#else
...
#ifdef __EMSCRIPTEN__
    entry.storageTextureFormat = rhi::TextureFormat::RGBA16Float;
#else
